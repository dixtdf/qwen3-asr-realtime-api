...
class ASRManager:
    ...
    def init_streaming_state(
        self,
        context: str = "输出纯中文文本，不带标点，过滤噪音。关键词：小爱同学、音量零、音量五、音量十、音量十五、音量二十、音量二十五、音量三十、音量三十五、音量四十、音量四十五、音量五十、音量五十五、音量六十、音量六十五、音量七十、音量七十五、音量八十、音量八十五、音量九十、音量九十五、音量一百、音量加、音量减、电脑开机、电脑关机、烧水、加热、电视、睡觉、直播、开屏、关屏、主页、返回、确定、菜单、上一集、下一集、开灯、卧室灯、台灯、客厅灯、厕所灯、厨房灯、次卧灯、阳台灯、关灯、电热毯高温、电热毯低温、开电热毯、关电热毯、游戏、日光、卧室灯加、卧室灯减、卧室灯色加、卧室灯色减、关风扇、开风扇、风扇上、风扇下、风扇左、风扇右。",
